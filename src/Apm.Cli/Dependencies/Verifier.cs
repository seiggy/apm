...
public static class Verifier
{
    ...
    /// <returns>Parsed ApmManifest, or null if loading failed.</returns>
    public static ApmManifest? LoadApmConfig(string configFile = "apm.yml")
    {
        try
        {
            ...
            return YamlFactory.UnderscoreDeserializer.Deserialize<ApmManifest>(content);
        }
        catch (Exception e)
        {
